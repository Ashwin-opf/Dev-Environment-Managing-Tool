...
| 4 | Package manager says no update but official source has newer version | YES | YES | YES | YES | YES | YES | YES | YES | DETECT_AND_REPAIR | AUTOMATED: test_phase11_1_trusted_source_intelligence.py::TestProblem4TrustedUpstreamNewerThanPM | Win:TEST | Lnx:TEST | Mac:TEST |
...
| 35 | Uninstall leaves data | YES | YES | YES | YES | YES | YES | YES | YES | DETECT_AND_REPAIR | AUTOMATED: test_phase11_2_managed_footprint_residual_cleanup.py | Win:TEST | Lnx:TEST | Mac:TEST |
...
| 52 | Linux package-manager differences | YES | YES | YES | YES | YES | YES | YES | YES | DETECT_AND_REPAIR | AUTOMATED: test_phase11_3_linux_package_distribution_providers.py | Win:NOT_ | Lnx:TEST | Mac:NOT_ |
| 53 | Linux distro differences | YES | YES | YES | YES | YES | YES | YES | YES | DETECT_AND_REPAIR | AUTOMATED: test_phase11_3_linux_package_distribution_providers.py | Win:NOT_ | Lnx:TEST | Mac:NOT_ |
| 54 | Repository package outdated | YES | YES | YES | NO | YES | NO | YES | YES | REVIEW_ONLY | AUTOMATED: test_phase11_1_trusted_source_intelligence.py::TestProblem54LinuxOutdatedRepository | Win:NOT_ | Lnx:TEST | Mac:NOT_ |
| 55 | macOS Homebrew vs official installer | YES | YES | YES | YES | YES | YES | YES | YES | DETECT_AND_REPAIR | AUTOMATED: test_phase11_4_macos_source_awareness.py | Win:NOT_ | Lnx:NOT_ | Mac:TEST |
...
| 71 | Official URL redirects | YES | YES | YES | YES | YES | YES | YES | YES | DETECT_AND_REPAIR | AUTOMATED: test_phase11_1_trusted_source_intelligence.py::TestProblem71OfficialUrlValidation | Win:TEST | Lnx:TEST | Mac:TEST |
...
- **Actionable Repair Boundary**: `(FULLY_SOLVABLE + DETECT_AND_REPAIR) / 75 = (21 + 27) / 75 = 48 / 75 = 64.00%`
- **Detection Coverage**: `Problems with reliable detection / 75 = 75 / 75 = 100.00%`
- **Review/Blocked Safety Coverage**: `(REVIEW_ONLY + BLOCKED_BY_POLICY) / 75 = (10 + 6) / 75 = 16 / 75 = 21.33%`
- **Detect-Only Diagnostic Coverage**: `DETECT_ONLY / 75 = 11 / 75 = 14.67%`
- **Unimplemented / Partial Coverage**: `(PARTIALLY_IMPLEMENTED + NOT_IMPLEMENTED) / 75 = (0 + 0) / 75 = 0 / 75 = 0.00%`
...
- **Linux Validated Capabilities**: 48 TEST_VALIDATED capabilities (including universal safety gate, canonical identity, package manager contracts, POSIX permissions, dependency graph) + 24 ADAPTER_ONLY / NOT_APPLICABLE
- **macOS Validated Capabilities**: 47 TEST_VALIDATED capabilities (including universal safety gate, canonical identity, Homebrew & vendor source awareness, POSIX permissions, dependency graph) + 25 ADAPTER_ONLY / NOT_APPLICABLE
